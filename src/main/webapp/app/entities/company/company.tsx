    ...
    return (
      <div>
        <h2 id="company-heading">
          <Translate contentKey="cidApp.company.home.title">Companies</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="cidApp.company.home.createLabel">Create a new Company</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('addressLine1')}>
                    <Translate contentKey="cidApp.company.addressLine1">Address Line 1</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('addressLine2')}>
                    <Translate contentKey="cidApp.company.addressLine2">Address Line 2</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th className="hand" onClick={this.sort('companyLogo')}>
                    <Translate contentKey="cidApp.company.companyLogo">Company Logo</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
