...
export class CompanyDeleteDialog extends React.Component<ICompanyDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this._isMounted, this.props.companyEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="cidApp.company.delete.question">
          <Translate contentKey="cidApp.company.delete.question" interpolate={{ id: companyEntity.id }}>
